...
const ArrowCard: React.FC<ArrowCardProps> = ({ title, description, extra }) => {
  return (
    <div className="relative group flex flex-nowrap p-4 pr-10 rounded-lg border border-gray-200 dark:border-white/20 hover:bg-black/2 dark:hover:bg-white/6 transition-[background-color] duration-300 ease-in-out">
