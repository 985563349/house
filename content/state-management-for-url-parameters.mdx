...
description: "把筛选、分页等状态放进 URL，让页面可分享、可刷新、利于 SEO。"
categories:
  - React
---
        ...
        return (
          <button
            ...
            onClick={() => {
              ...
              setSearchParams(newGenres.map((genre) => ['genre', genre] as [string, string]));
            }}
          >
            {value}
          </button>
...
```typescript use-search-params.ts
...
<CodeSandboxEmbed url="https://codesandbox.io/embed/dcclzh?view=preview" />
