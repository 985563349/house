...
```ts
// [!meta title:next.config.ts copy]
...
> TIP：需要将 your-server-ip 替换为你的服务器公网 IP。

```bash
# [!meta title:bash copy]
# [!code word:your-server-ip]
...
> TIP：需要将 file-name 替换为你的文件名，your-server-ip 替换为你的服务器公网 IP。
...
> TIP：需要将 your-domain 替换为你的域名，file-name 替换为你的证书文件名。

```nginx
# [!meta title:default copy]
# [!code word:your-domain]
# [!code word:file-name]
server {
        # SSL configuration
        #
...
```bash
# [!meta title:bash copy]
# [!code word:your-email@example.com]
